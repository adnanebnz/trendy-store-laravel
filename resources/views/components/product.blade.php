...
<article class="flex flex-col lg:flex-row pb-10 md:pb-16 border-b">
    <div class="lg:w-5/12">
        <img class="w-full object-cover"
            ...
            @if(!$list)
            <h1 class="mx-auto text-2xl font-semibold text-slate-800 mt-7">Acheter ce produit</h1>
                        ...
                        <form action="{{ route('order.store') }}" method="POST">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="number" name="quantity" id="quantity" min="1" value="1"
                                  max="{{$product->stock}}"  class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-indigo-500 focus:shadow-md" />
                            </div>
