    ...
    <div class="sticky w-full bottom-0 left-0 right-0 flex flex-col gap-2 bg-orange-100 py-4 shadow-xl rounded-t-2xl"
        ...
        @if ($product->shipping_price)
            <div class="md:px-5 px-3 py-1">
                <h1 class="md:text-xl text-lg text-slate-800"><span class="text-green-500 font-bold mr-2 md:mr-5">DZD
        ...
        <div class="flex items-center justify-center">
            <div class="flex items-center justify-center">
                ...
                <h1 x-text="price * quantity +' DZD'"
                    class="text-sm md:text-lg font-bold text-slate-800 outline-none focus:border-amber-500 focus:shadow-md mr-2 md:mr-5">
                </h1>
